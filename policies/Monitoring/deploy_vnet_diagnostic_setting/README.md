# Deploy Diagnostic Settings on Virtual Networks

## Display Name

Deploy Diagnostic Settings for Virtual Networks to Log Analytics workspace, Event Hub and Storage Account
...
Deploys the diagnostic settings for Virtual Networks to stream to a regional Log Analytics workspace, Event Hub and Storage Account when any Event Hub which is missing this diagnostic settings is created or updated.
...
## Assignment
```hcl
module logging_mg_deploy_vnet_diagnostic_setting {
  source                = "github.com/gettek/azurerm-terraform-policy-as-code.git//modules/def_assignment?ref=1.2.0"
  definition_name       = "deploy_vnet_diagnostic_setting"
